      ...
      <div class="flex flex-row w-fit pt-4 pl-6 md:pl-0">
        ...
        <div class="rounded-full">
          <a href="https://www.instagram.com/siamoalpi/" target="_blank">
            ...
            <svg class="w-8 h-8 fill-blu-sa hover:fill-white transition-all" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 39.7 39.7" xml:space="preserve">
            <g>
              <g>
        ...
        <div class="rounded-full ml-2">
          <a class="" href="https://www.facebook.com/SiamoAlpi/" target="_blank">
            ...
            <svg class="w-8 h-8 fill-blu-sa hover:fill-white transition-all" version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 39.7 39.7" xml:space="preserve">
