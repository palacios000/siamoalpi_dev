...
<div x-data="{ menu: false }" class="slanted-br-m relative text-white h-fit">
    ...
    <!-- logo 1 -->
        ...
        <div class="absolute top-0 left-0 w-82 mt-3 ml-1.5">
            <a class="" href="<?= $homeNew ?>">
                <img class=""  
                src="<?= $config->urls->templates?>pictures/logo/siamo-alpi-bianco.svg " alt="Logo"
                onmouseover="this.src='<?= $config->urls->templates?>pictures/logo/siamo-alpi-bianco-hover.svg';"
    ...
    <!-- logo 2 animato da me -->

    <script>
/*        // setInterval(function blinkeyes() {
        //   var tl = new TimelineLite();
        //   tl.to(".sfoglia", .4, {scaleY:.01, repeat:3, repeatDelay:.4, yoyo:true, transformOrigin: "50% 70%", ease:Power2.easeInOut});
        //   return tl; 
        //  }, 5000);
        ...
        gsap.to(".sfoglia", {duration: 3, rotation: 360, scale: 0.5});
*/
    </script>
        ...
        <!-- <div class="absolute top-0 left-0 w-82 mt-3 ml-1.5">
            <a class="" href="<?= $homeNew ?>">
               ...
               <polygon class="sfoglia" points="545,77.3 477.9,286.9 843.5,404 876.7,299.9 877.3,299.9 884.8,276.7 545,276.7 "/>
               <g>
