...
<nav x-data="{ menu: false }" class="slanted-br-m relative text-white h-fit">
    <!-- Background image -->
    <img class="object-cover overflow-hidden w-full h-full"  src="<?= $bannerBgImg ?>" alt="">
    
    <!-- Logo -->
        <div class="absolute top-0 left-0 w-82 mt-3 ml-1.5">
            <a href="<?= $homeNew ?>">
                <img class=""  
    ...
    <div class="h-0" x-on:click="menu = true">
        <button type="button" x-show="!menu" aria-label="Menu navigazione" aria-expanded="false" tabindex="0">
            <svg class="text-white block h-8 w-8 absolute top-10 right-12" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
    ...
    <!-- Modal AlpineJS-->
        ...
        >
            ...
            >
                <!-- close botton -->
                <button class="absolute top-10 right-12" x-on:click="menu = ! menu" aria-label="Nascondi Menu di navigazione">
