...
<body class="blog-width mx-auto bg-black/80">
  ...
  <div class="slanted-header relative bg-marrone-sa text-white h-fit -z-20">
    ...
    <!-- Logo -->
    <img class="absolute top-0 left-0 w-80 mt-[24px] ml-[8px]"  src="../site/templates/pictures/logo/siamo-alpi-bianco.svg " alt="Logo">
  ...
  <!-- Main content div -->
  <div class="slanted-tr-s relative pb-40 pt-1 bg-white z-0 before:-z-10">
    <!-- Title -->
    <h1 class="h5-sa uppercase underline underline-offset-2 pl-12 pt-[64px] pb-5 w-3/5">
      Le tradizioni siamo noi
    </h1>

    <div class="px-56 mx-auto">
      <!-- First text section -->
      <div class="py-24">
      ...
      <!-- Picture -->
      <div class="">
        <img src="http://via.placeholder.com/760x540" alt="">
        <!-- Description -->
        <div class="text-center pt-7">
          <!-- add text-sm -->
          Must add p-small paragraph here
        </div>
      </div>
  ...
  <!-- Grid div -->
  <div class="slanted-tl-m h-fit z-40 before:-z-10 mx-auto pt-32 pb-48 bg-grigio-scuro-sa">
    <!-- Content container -->
    <div class="mx-auto w-fit pb-20">
      <!-- Title -->
      <div class="text-white text-left font-serif pb-5 text-md">
    ...
    <!-- Plus icon -->
    <svg class="w-12 h-12 mx-auto" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      <path fillRule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clipRule="evenodd"/>
      <circle cx="10" cy="10" r="8" fill="none" stroke-width="0.8" stroke="white"/>
  ...
  <!-- Footer div -->
  <div class="slanted-tr-l pt-20 z-50 before:-z-10 relative grid grid-cols-2 text-white bg-verde-sa">
    <!-- Logo -->
    <img class="w-80 mt-[24px] ml-[8px]"  src="../site/templates/pictures/logo/siamo-alpi-bianco.svg " alt="Logo">
